...
import { backEndComponent, initFrontEndControlRoutes, transformMenuToRoutes } from '/@/router/frontEnd';
...
export function setFilterRouteEnd() {
	const tranData = transformMenuToRoutes(Session.get('menuList') || []);
	const menuList = backEndComponent(tranData);
